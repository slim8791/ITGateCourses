...
namespace ModelFirstCore.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PersonnelsController : ControllerBase
    {
        private readonly ModelFirstCoreContext _context;

        public PersonnelsController(ModelFirstCoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Personnel>> PostPersonnel(Personnel personnel)
        {
          if (_context.Personnel == null)
          {
              return Problem("Entity set 'ModelFirstCoreContext.Personnel'  is null.");
          }
